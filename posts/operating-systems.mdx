...
This post serves as a study guide. All the information has been obtained from available sources. You can find all links used at the end of the post.
...
<Box question="Producer Consumer Problem examples">
  ...
  <Box question="What is wrong with this implementation? How to fix it?">
    ...
    <Box question="Consumer">
      ...
      3. Producer thread cannot increment the value of items, since its waiting for the consumer to release the mutex
